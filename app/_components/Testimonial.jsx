      ...
      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-lg font-medium text-gray-900">John Doe, Fashion Enthusiast</p>
          </div>
        </div>
      ...
      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-lg font-medium text-gray-900">Jane Smith, Online Shopper</p>
          </div>
        </div>
      ...
      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-lg font-medium text-gray-900">Emily Johnson, Fashion Blogger</p>
          </div>
        </div>

        <p className="mt-4 text-gray-700">
        As a fashion blogger, I rely on Fashion Tour for the latest trends and unique pieces. Their collection is always up-to-date with the current styles, and the quality never disappoints. The prices are reasonable, and the frequent sales make it even better. Fashion Tour is my go-to online store for everything fashion-related.
        </p>
      </blockquote>
    </div>
  </div>
